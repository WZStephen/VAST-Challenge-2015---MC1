...
df = pd.read_csv(r'./data/XyWithTypeNoNull.csv')
...
test = []
df.loc[df['Real World Type'] == 'Long Coaster', 'type_y'] = "Coaster"
df.loc[df['Real World Type'] == 'Metal Coaster', 'type_y'] = "Coaster"
df.loc[df['Real World Type'] == 'Wooden Coaster', 'type_y'] = "Coaster"
df.loc[df['Real World Type'] == 'Wild Mouse', 'type_y'] = "Coaster"
df.loc[df['Real World Type'] == 'Up and Back Coaster', 'type_y'] = "Coaster"
df.loc[df['Real World Type'] == 'SkyDiver', 'type_y'] = "Centrifuge"
df.loc[df['Real World Type'] == 'Centrifuge', 'type_y'] = "Centrifuge"
df.loc[df['Real World Type'] == 'Fireball', 'type_y'] = "Centrifuge"
df.loc[df['Real World Type'] == 'Ali Baba', 'type_y'] = "Centrifuge"
...
for sentence in df_merge['type_y']:
    counts = Counter()
    counts.update(word.strip('[].,?!"\'').lower()
